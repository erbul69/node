...
const server = http.createServer(function(req, res){
    if(req.url == "/setip"){
        ...
        html += '<h2>Merhaba!</h2><p><b>Ip Adress:</b> ' + ip + '</p><p><b>Güncelleme:</b><span id="date"> ' + update_time + '</span></p></body></html>';
        html += '<script>document.getElementById.innerText = ' + update_time + '.toLocaleString("tr-TR")</script>'
